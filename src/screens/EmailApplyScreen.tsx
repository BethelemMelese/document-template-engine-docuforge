...
export function EmailApplyScreen() {
  ...
  const { content, company, position, email } = (location.state as { content?: string; company?: string; position?: string; email?: string }) || {
    content: '',
    company: '',
    position: '',
    email: '',
    ...
    return (
      <div className="min-h-screen bg-background-light dark:bg-background-dark flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-900 dark:text-gray-100 font-semibold mb-2">No Content Found</p>
          <p className="text-gray-600 dark:text-gray-400 mb-6">Please generate a cover letter first before proceeding to email.</p>
