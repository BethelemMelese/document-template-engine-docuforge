...
import { getTemplate, createTemplate, updateTemplate } from '../storage/apiStorage';
...
export function TemplateEditorScreen() {
  ...
  const handleSave = useCallback(async (): Promise<Template | null> => {
