    ...
    <div className="w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 h-screen fixed left-0 top-0 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-gray-900 dark:text-gray-100">LetterForge</h1>
            <p className="text-xs text-gray-500 dark:text-gray-400">SaaS Dashboard</p>
          </div>
        </div>
      </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              <li key={item.path}>
                ...
                >
                  <span className={active ? 'text-primary dark:text-primary-400' : 'text-gray-500 dark:text-gray-400'}>
                    {item.icon}
                  </span>
